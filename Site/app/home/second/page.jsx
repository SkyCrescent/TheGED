...
export default function page() {
   ...
   return(
      <>
                              ...
                              <div
                                 ...
                                 <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                        ...
                                        <span
                                           className="text-sm text-justify text-white ">Accedez a vos fichiers personnels</span>
                                 ...
                                 <div
                                    ...
                                    <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                          ...
                                          <div
                                             className="absolute bottom-3 text-white font-light  h-auto w-[100%]  items-center justify-center text-center ">
                                        <span
                                 ...
                                 <div
                                    ...
                                    <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                          ...
                                          <div
                                             className="absolute bottom-1 text-white  h-auto w-[100%]  items-center justify-center text-center ">
                                        <span
                                 ...
                                 <div
                                    ...
                                    <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                          ...
                                          <div
                                             className="absolute bottom-3 text-white h-auto w-[100%]  items-center justify-center text-center ">
                                        <span
                                           className="text-sm text-justify   ">Partager vos fichiers avec differente personne de votre direction</span>
                                 ...
                                 <div
                                    ...
                                    <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                          ...
                                          <div
                                             className="absolute   h-auto w-[100%] bottom-5 text-white items-center justify-center text-center ">
                                        <span
                                           className="text-sm text-justify  ">Pour voir vos différentes activites sur MyGED</span>
                                    ...
                                    : click === 7 ? <Admi />
                                       : click === 9 ? <NOTREGED
                                             ...
                                             updateactuNotif={updateactuNotif} structure={structure}
                                                                 RefreshTransmissionInterne={RefreshTransmissionInterne}
                                                                 updateRefreshTransmissionInterne={updateRefreshTransmissionInterne}
                                                                 valueInTransmission={valueInTransmission}
                                                                 updateValueNotifications={updateValueNotifications}
         ...
         {
            SendInterne ? ( <  Transmission structure={structure} updateactuNotif={updateactuNotif} RefreshTransmissionInterne={RefreshTransmissionInterne} updateRefreshTransmissionInterne={updateRefreshTransmissionInterne} SetInterne={SetInterne} id={structure}  updateCourrier={updateCourrier} valueInTransmission={valueInTransmission}  handleClickButton8={handleClickButton8} updateValueNotification={updateValueNotification}  updateValueNotifications={updateValueNotifications} /> ) :null
         }
         ...
         {
            EnterCourrier ? ( <NewCourrierArrive updateshowHeader={updateshowHeader}  handleClickButton8={handleClickButton8} id={structure}  updateValueNotification={updateValueNotification} SetEnterCourrier={SetEnterCourrier} />) : null
