             ...
             <div
                ...
                <div className="h-[100%] w-[55%] flex  items-center mt-8 rounded ">
                   ...
                   <div className="relative h-[60%] mx-3 items-center  w-[100%]  ">
                      ...
                      <h1 className="text-3xl mx-1 font-semibold">Votre Compte Utilisateur a été créé avec succès.</h1>
                      <h1 className="text-sm py-2 mx-2 ">Vous pouvez désormais accéder a votre Workspace
                         sur <span
                            className="font-normal text-blue-600 underline underline-offset-1 shadow-blue-300"> MyGED</span>.
                      </h1>
                      <div className=" -mx-1  ">
