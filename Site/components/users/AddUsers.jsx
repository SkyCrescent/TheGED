...
export default function AddUsers({SetDoc2,updateValueNotifications,handleClickButton8}){
                  ...
                  <div
                     ...
                     <div className="h-[80%] w-[40%] flex  items-center mt-8 rounded ">
                        ...
                        <div className="relative h-[60%] mx-3 items-center  w-[100%] ">
                           ...
                           {/*</h1>*/}
                           <h1 className="text-3xl  font-semibold  text-blue-600  shadow-blue-300"> Gestionnaire Electronique de Document</h1>
