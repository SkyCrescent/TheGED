...
export default function page() {
   ...
   const [UpdateValueParafeure, setUpdateValueParafeure] = useState(false); //constante qui permettra d'actualiser le page des parafeure des que le formulaire note est valide
   const TheUpdateValueParafeure = (newValue) => {
      setUpdateValueParafeure(newValue);
   };
   ...
   const getData = async () => {
      try {
         const response = await axios.get(`http://localhost:8000/agent/get_byId.php?id=${decodedData}`);
         ...
         <div className="relative w-[100%] h-screen flex justify-between">
            ...
            <div
               ...
               <div className="relative  h-[92%] cursor-pointer w-[100%] overflow-y-auto scrollbar-hidden">
                  <div
                     ...
                     <div className="relative  w-[90%] mx-3 space-x-9 flex items-center justify-center">
                        <img src={house.src} alt=""
                             ...
                             height={25}/>
                        <span
                           className={reduce ? ' hidden transform duration-200' : 'block font-extralight relative text-left  w-[60%] text-[16px] font-[Trebuchet] shadow-blue-300   transform duration-200'}>Acceuil</span>
                  ...
                  >
                     {/* Couleur bleue */}
                     <div className={click === 6 || click === 11 ? "relative  w-[3%] bg-blue-500" : "hidden"}></div>
                                 ...
                                 <div
                                    ...
                                    <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                        ...
                                        <span
                                           className="text-sm text-justify  font-semibold">Pour voir vos différentes activites et ceux de vos agents sur MyGED</span>
                                 ...
                                 <div
                                    ...
                                    <div className="relative h-[100%] w-[100%] flex items-center justify-center ">
                                       ...
                                       <div
                                        ...
                                        <span
                                           className="text-sm text-justify ">Pour la Gestion de votre compte,voir vos informations personnels...</span>
            ...
            {/*a envoyer partout const [UpdateValueParafeure, setUpdateValueParafeure] = useState(false); //constante qui permettra d'actualiser le page des parafeure des que le formulaire note est valide
   */}
            </div>
         ...
         {/*{*/}
         {/*   addDoc ? ( <AddDoc  id={decodedData} updateValueNotification={updateValueNotification} handleClickButton8={handleClickButton8} structure={structure}  SetAdmin ={SetDoc}    /> ) : null*/}
         {/*}*/}


         {/*Formulaire d'ajout de fichiers des autres*/}
         {
            addDoc ? ( <AddDoc  id={decodedData} updateValueNotification={updateValueNotification} handleClickButton8={handleClickButton8} valueNotifications={valueNotifications} updateValueNotifications={updateValueNotifications} structure={structure}  SetAdmin ={SetDoc}    /> ) : null
         }
         ...
         {
            ShowReturn ? (  <Return TheUpdateValueParafeure={TheUpdateValueParafeure} UpdateYourValueTransmission={UpdateYourValueTransmission} updateValueNotification={updateValueNotification} handleClickButton8={handleClickButton8} ValueInArrive={ValueInArrive}  updateactuNotif={updateactuNotif}  structure={structure} poste={poste} setReturn={setReturn} /> ) : null

         }
         {
            ShowHistoric ? ( <DirectorHistoric idAgent={idAgent} setShowHistoric={setShowHistoric} /> ) : null
         }
      </>
   )
}