...
if (isset($_POST['nom'], $_POST['prenom']
    ...
    $query = $con->prepare("INSERT INTO agent (nom, prenom,adresse,num_phone,situation,poste_agent,username,password,id_structure,photo) VALUES (?,?, ?,?,?,?,?,?,?,?)");
    $query->bind_param("ssssssssis", $nom, $prenom,$adresse,$num_phone,$situation,$poste_agent,$username,$password,$id_structure,$photo);
    if ($query->execute()) {
        $answer['error'] = false;
