...
//    $query = $con->prepare("SELECT id,nom,nom_fichier,url_fichier,extension,id_agent,nom_agent,date_ajout FROM doc_strucutre WHERE id_structure = ? and  nom LIKE CONCAT( ?, '%') and archive='non' ");
    $query = $con->prepare("SELECT id,nom,date,nom_fichier,url_fichier,extension FROM doc WHERE id_agent = ? and  nom LIKE CONCAT( ?, '%') and archive = 'non' ");
...
//        $answer['num_rows'] = $numRows;
    ...
    $query = $con->prepare("SELECT id,nom,date,nom_fichier,url_fichier,extension FROM doc WHERE id_agent = ? and  extension = ? and archive = 'non' ");
...
//        $answer['num_rows'] = $numRows;
    ...
    $query = $con->prepare("SELECT id,nom,date,nom_fichier,url_fichier,extension FROM doc WHERE id_agent = ? and  extension = ? and nom = ? and archive = 'non' ");
