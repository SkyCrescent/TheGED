...
if (isset($_GET['recepteur'] ,$_GET['Type_transmission'] )) {
  ...
  $Type_transmission = $_GET['Type_transmission'];
    ...
    $query = $con->prepare("SELECT id,objet, expediteur,date,parafeux,Niveau,transmission_interne,note,accuse FROM courier WHERE recepteur = ? and Type_transmission = ? ORDER BY 1 DESC");
